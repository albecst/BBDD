...
GRANT CREATE ON SCHEMA base_discos TO admin;
...
GRANT SELECT, DELETE, INSERT ON base_discos.Tiene, base_discos.Desea, base_discos.Grupo,
base_discos.Disco, base_discos.Cancion, base_discos.Edicion TO cliente;
GRANT SELECT, INSERT ON TABLE auditoria TO cliente;
-- Se han asignado mas permisos de los que pone en el enunciado porque si no el cliente 
-- no puede insertar discos  en "Tiene" que no esten en "Disco"
